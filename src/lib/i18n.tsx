...
const dict = {
  en: {
    ...
    "win.eyebrow": "Hall of fame",
    "win.title1": "They played.",
    "win.title2": "They won.",
    "win.body": "Celebrating the players who have already conquered Albastini tournaments.",
    "win.all": "All",
    "win.champion": "Champion",
    "win.runnerup": "Runner-up",
    "win.third": "Third place",
    "win.finalist": "Finalist",
    "win.prize": "Prize",

    "phys.eyebrow": "Physical deck",
    ...
    "phys.cta": "Notify me when available",
    "form.email": "Email address",
    "form.placeholder": "you@example.com",
    "form.submit": "Notify me",
    "form.thanks1": "Thank you.",
    "form.thanks2": "We'll let you know.",
  ...
  sw: {
    ...
    "win.eyebrow": "Ukumbi wa umaarufu",
    "win.title1": "Walicheza.",
    "win.title2": "Walishinda.",
    "win.body": "Tunawapongeza wachezaji waliokwisha kutwaa mashindano ya Albastini.",
    "win.all": "Yote",
    "win.champion": "Bingwa",
    "win.runnerup": "Wa pili",
    "win.third": "Wa tatu",
    "win.finalist": "Fainali",
    "win.prize": "Zawadi",

    "phys.eyebrow": "Deki halisi",
    ...
    "app.soon": "Inakuja hivi karibuni",
    "app.android": "Android",
    "app.ios": "iOS",
    "app.cta": "Pakua app",
    ...
    "final.sub": "Tucheze Albastini.",
    "final.cta1": "Cheza sasa",
    "final.cta2": "Pakua app",
